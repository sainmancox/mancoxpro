...
satpam.login(token='ErWLqVBvT2mc5pu9JxV7.aecM38cIDpkyMCZpWCM0vW.t7zmM9WRcsMX696o58ExkpyodYLEc+2JYoDj94Ha9aU=')
satpam.loginResult()

cl = LINETCR.LINE() # SATU
cl.login(token='ErZKJNBsZbZlEY4zQ5Fc.CVbaAU5SpCbphLhxg3E13a.hchg+i/pR0wMFyIjqdmn0rkEivbhyyrrS7nxvHV1kqs=')
cl.loginResult()

ki = LINETCR.LINE() # DUA
ki.login(token='ErIMPlk5t5ut5vG0SRm1.j7RUpPeXybUVD+0Ydpdkuq.AtN9y24Rk+kuOMPCyGOHdvdB1t7u1wd7ktOgTS9ejpY=')
ki.loginResult()

kk = LINETCR.LINE() # TIGA
kk.login(token='ErgSVCTOMeeQzqntpN0f.v8WUV7zaKF8ZRiI7iBN47W.YflJwgYeb4JAqVr7seWdiMqC/IXE/mndMhhOTy86Wg4=')
kk.loginResult()

kc = LINETCR.LINE() # EMPAT
kc.login(token='ErwBY7Nf32h98nsnkCBc.UOraNNyaodWBBVj9GosNVa.3n61t7hTsreq9ieuPTsao21RsU8WWhLVRSwk8psh1HI=')
kc.loginResult()

ks = LINETCR.LINE() # LIMA
ks.login(token='ErnEeHp9QCzPYGpkgeS0.9qLSPfl50NyXB816jTcAia.hvwc6cKLnsmekQ5QAOEQd7lJH9DzCDYL1M3houupqiQ=')
ks.loginResult()

ka = LINETCR.LINE() # ENAM
ka.login(token='ErKeCFLa5KYthg7eFCW8.ES/0VcKnSua4D01xkmmJ2a.epCI33bciw27Fw9DqnXwDkTBaPR74fYtvqaEdDCj/wU=')
ka.loginResult()

kb = LINETCR.LINE() # TUJUH
kb.login(token='ErENAul6aOSlk8FEzHq6.nElASghLStYHD9GtNRAGrG.TJ4zaluN4b3GiYHS4Hi9iG+DrdVfFASwrX+SCDzHQLI=')
kb.loginResult()

ko = LINETCR.LINE() # DELAPAN
ko.login(token='Er6XYsV7OwpOjFOdoou7.i1CA2Puh0p+mRZZZkIzyTW.x7DqqxY1e0qW49ZF3zWmanqKr7CBL/kJGIgZ+oI9sQc=')
ko.loginResult()

ke = LINETCR.LINE() # SEMBILAN
ke.login(token='ErtdTJqLYeITAubXlaKf.Q+icaoMmIJVaeh4kvsUlVW./CY2WpEXwldq3f46GqJ3ZOUP80RV+8EIQHtlGegmYKI=')
ke.loginResult()

ku = LINETCR.LINE() # SEPULUH
ku.login(token='Er0xep88i8FX9RZjf53a.Kd6xrCGqNonnXQl05Q/TMG.8x0Ku13FCfST83ey6VsmXb3rGNsqM6kE5IC4YardFF8=')
ku.loginResult()
...
k1.login(token='EruhK3MytMGCCAtiQat3.5+FzlbvgCYo9FGn+qaxiOW.ZDWa2t2z2ztkzLtUUA8CMUve2vUOapfiHnbvtbrfZOw=')
k1.loginResult()

print "=>T.M.B LOGIN SUCCESS <="
reload(sys)
sys.setdefaultencoding('utf-8')

helpMessage ="""🍁հմՏɑíղ✍️"""
...
mid = cl.getProfile().mid # SATU
Amid = ki.getProfile().mid # DUA
Bmid = kk.getProfile().mid # TIGA
Cmid = kc.getProfile().mid # EMPAT
Dmid = ks.getProfile().mid # LIMA
Emid = ka.getProfile().mid # ENAM
Fmid = kb.getProfile().mid # TUJUH
Gmid = ko.getProfile().mid # DELAPAN
Hmid = ke.getProfile().mid # SEMBILAN
Imid = ku.getProfile().mid # SEPULUH
#Jmid = cl.getProfile().mid # SEBELAS
#Kmid = ki.getProfile().mid # DUA BELAS
#Lmid = kk.getProfile().mid # TIGA BELAS
#Mmid = kc.getProfile().mid # EMPAT BELAS
#Nmid = ks.getProfile().mid # LIMA BELAS
#Omid = ka.getProfile().mid # ENAM BELAS
#Pmid = kb.getProfile().mid # TUJUH BELAS
#Qmid = ko.getProfile().mid # DELAPAN BELAS
#Rmid = ke.getProfile().mid # SEMBILAN BELAS
#Tmid = ku.getProfile().mid # DUA PULUH
#Umid = ke.getProfile().mid # DUA PULUH SATU
#Vmid = ku.getProfile().mid # DUA PULUH DUA
Smid = satpam.getProfile().mid #Akun Utama
mid1 = k1.getProfile().mid #Backup
#mid2 = k2.getProfile().mid #Backup
#mid2 = k3.getProfile().mid #Backup

Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Imid,Smid,mid1]
admin=["u0040a6dfc0a274f29899cccfc1c9b457","u3cfa63811888b3a880bc4f348a95b23b","u7d14806b84f1bbd39884c7b0a1f2ca90","u4a03e5ee61f157e57bf02aec32dec338","u0eb49bbbbbcd8d157290a5079a1cc5ca"] 
owner=["u0040a6dfc0a274f29899cccfc1c9b457","u3cfa63811888b3a880bc4f348a95b23b","u7d14806b84f1bbd39884c7b0a1f2ca90","u4a03e5ee61f157e57bf02aec32dec338"]
wait = {
    'contact':False,
    'autoJoin':True,
...
#--------------------------------
    ...
    #-----------------=Selesai=------------------
              ...
              if msg.from_ in admin:
                ...
                k1.sendMessage(msg)
                cl.sendText(msg.to,"Contact Complete")
            elif msg.text in ["Me"]:
              if msg.from_ in admin:
                msg.contentType = 13
			...
			if wait["atjointicket"] == True:
              ...
              if msg.from_ in owner:
                ...
                if len(string.decode('utf-8')) <= 20:
                    ...
                    profile.displayName = string
                    ko.updateProfile(profile)
                    ko.sendText(msg.to,"change name: "+string+"\nsucces")
              ...
              if msg.from_ in owner:
                ...
                if len(string.decode('utf-8')) <= 20:
                    ...
                    profile.displayName = string
                    ku.updateProfile(profile)
                    ku.sendText(msg.to,"change name: "+string+"\nsucces")
            elif "Bot11 rename:" in msg.text:
              if msg.from_ in owner:
                string = msg.text.replace("Bot11 rename:","")
                if len(string.decode('utf-8')) <= 20:
                    profile = k1.getProfile()
                    profile.displayName = string
                    k1.updateProfile(profile)
                    k1.sendText(msg.to,"change name: "+string+"\nsucces")
            elif msg.text in ["Mc "]:
              if msg.from_ in admin:
...
#-----------------------------------------------
                    ...
                    print "[Command]R.E.B.O.O.T"
                    try:
                        cl.sendText(msg.to,"Rebooting...")
                        restart_program()
                    except:
                        cl.sendText(msg.to,"Reboot Succes")
                        restart_program()
                        pass
